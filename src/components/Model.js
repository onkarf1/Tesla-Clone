  ...
  return (
    <div>
      <div className="absolute inset-x-0 top-[15%] text-center">
        ...
        <p className="text-sm p-2">Order Online for <a href="https://www.tesla.com/inventory/new/my"><span className="underline underline-offset-4 hover:cursor-pointer">Touchles Delivery</span></a>
